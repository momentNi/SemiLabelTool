...
from utils.calculator import distance, hex_to_rgb
...
class Canvas(QtWidgets.QWidget):
    ...
    def mouseMoveEvent(self, ev):  # noqa: C901
        ...
        # Polygon drawing.
        if self.drawing():
            line_color = hex_to_rgb(self.cross_line_color)
    ...
    def transform_pos(self, point: QPointF):
    ...
    def close_enough(self, p1, p2):
        ...
        return distance(p1, p2) < (EPSILON / self.scale)
    ...
    def rotate_by_keyboard(self, theta):
        """Rotate selected shapes by a theta (using keyboard)"""
        if self.selected_shapes:
